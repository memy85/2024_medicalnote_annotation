...
# MISTRAL_PATH = "/home/htran/generation/biomed_instruct/models/llama_2_7b_all_instructions/checkpoint-975"
...
#%%
#%%
# model = AutoModelForCausalLM.from_pretrained(MISTRAL_PATH, device_map="sequential")
...
#%%
import pickle
with open("../data/processed/zeroshot_mistral.pkl", 'wb') as f :
