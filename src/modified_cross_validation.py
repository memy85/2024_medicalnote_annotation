...
if __name__ == "__main__" :
    ...
    print("inference is ", inference, file=sys.stderr)
    print("topn is ", topn, file=sys.stderr)
    template = config.template(inference, topn)
    ...
    for idx, trainset in enumerate(cv5) : 
        ...
        if do_finetune :
            ...
            print("vanilla model & doing just evaluation", file=sys.stderr)
